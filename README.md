...
* The HTML must have:
    ...
    * a `main` element.(help) (7 points)

    * more than one `section` element (help). (7 points)
    
    * an `aside` (help) element. (7 points)
...
* The `header` element should have a (good)background color of `#2a607c`. (4 points)

* The `header` element should have a (good)text color of `#ffffff`. (4 points)

* The first three images should have (good)a `height` of `200px`. (4 points each)

* The last three images should have (good)a `height` of  `150px`. (4 points each) 

* The `footer` (good)' element should have `30px` padding. (4 points)

* The text in the `footer` element (good)should be centered. (4 points)
